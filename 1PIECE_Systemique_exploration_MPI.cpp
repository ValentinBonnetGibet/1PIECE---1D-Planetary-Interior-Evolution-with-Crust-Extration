...
std::fprintf(resume, "%i %i %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e\n",i,rank,t,k0_exp(k_i),eta0_exp(eta_i),Tp, Tm, Dc_N, Dc_S, Dl_N, Dl_S, Tc, Phicrmax_N, Phicrmax_S, dmax_cr_N,dmax_cr_S, std::get<0>(agecrust_N) ,std::get<0>(agecrust_S), std::get<1>(agecrust_N) ,std::get<1>(agecrust_S), rho_m,LMBD_cr_N,LMBD_cr_S,LMBD_lith_N,LMBD_lith_S,LMBD_ath,std::get<0>(dTdz_N), std::get<0>(dTdz_S), std::get<1>(dTdz_N), std::get<1>(dTdz_S), dBLC_N,dBLC_S);
fclose(resume);
